function roast_PA(subj,recipe,varargin)
...
if ~exist([dirname filesep baseFilename '_' uniqueTag '_mask_elec.nii'],'file')
    ...
    disp('======================================================')
    hdrInfo = electrodePlacement_PA(subj,subjRSPD,T2,elecName,options,uniqueTag);
else
    disp('======================================================')
...
if ~exist([dirname filesep baseFilename '_' uniqueTag '.mat'],'file')
    ...
    disp('======================================================')
    [node,elem,face] = meshByIso2mesh_PA(subj,subjRSPD,T2,meshOpt,hdrInfo,uniqueTag);
else
    disp('======================================================')
...
if ~exist([dirname filesep baseFilename '_' uniqueTag '_v.pos'],'file')
    ...
    disp('======================================================')
    prepareForGetDP_PA(subj,node,elem,hdrInfo,elecName,uniqueTag);
    solveByGetDP_PA(subj,injectCurrent,conductivities,uniqueTag);
else
    disp('======================================================')
