function segTouchup7(P,T2,isSmooth,conn)
...
[empt_temp,gray_temp,white_temp,csf_temp,bone_temp,skin_temp,air_temp,lesion.img]...
    = binaryMaskGenerate7(gray_temp,white_temp,csf_temp,bone_temp,skin_temp,air_temp,lesion.img);
...
empt_temp = binaryMaskGenerate7(gray_temp,white_temp,csf_temp,bone_temp,skin_temp,air_temp,lesion_temp);
...
while any(empt_temp(:))
    ...
    lesion_fil=uint8(lesion_temp)*255;
    sigma = [1 1 1 1 1 1 1];
    ...
    for i = 1:size(air_fil,3)
        ...
        smt_fil = fspecial('gaussian', 5, sigma(7));
    for i = 1:size(lesion_fil,3)
        img = lesion_fil(:,:,i);
        lesion_fil(:,:,i) = imfilter(img,smt_fil);
    end
    
    
    [~,lesion_fil,air_fil,gray_fil,white_fil,csf_fil,bone_fil,skin_fil]...
        = binaryMaskGenerate7(lesion_fil,air_fil,gray_fil,white_fil,csf_fil,bone_fil,skin_fil);
    ...
    lesion_temp = (empt_temp&gray_fil)|lesion_temp;

    
    empt_temp = xor(empt_temp,((empt_temp&gray_fil) | (empt_temp&white_fil) | (empt_temp&csf_fil)...
        | (empt_temp&bone_fil) | (empt_temp&skin_fil) | (empt_temp&air_fil) | (empt_temp&lesion_fil))); % update empty voxels
end
