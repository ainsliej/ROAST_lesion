function roast_wtemp(subj,recipe,varargin)
...
if ~exist('conductivities','var')
    conductivities = struct('white',1, 'gray',1,'csf',1, 'bone',1, 'skin',1,'air',2.5e-14,'gel',0.3,'electrode',5.9e7); % literature values
else
...
if ~strcmp(baseFilename,'nyhead')
    ...
    if (isempty(T2) && ~exist([dirname filesep 'c1' baseFilenameRSPD '_T1orT2.nii'],'file')) ||...
        ...
        disp('======================================================')
        start_seg(subjRSPD,T2, template);
    else
        disp('======================================================')
